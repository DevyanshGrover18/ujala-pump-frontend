...
export function PlumberSideBar({ sidebarOpen, toggleSidebar }) {
          ...
          >
            {sidebarOpen && (
              <div className="flex items-center space-x-3">
                ...
                />
                <div>
                  <div className="text-sm font-extrabold">Plumber</div>
          ...
          <div className="mt-auto">
            {sidebarOpen ? (
              <div className="mt-4">
                ...
                >
                  <div className="p-2 rounded-full flex items-center justify-center transition-colors duration-200 flex-shrink-0 bg-white/10 text-white/90">
              ...
              <div className="mt-4 flex items-center justify-center">
                <button
                  onClick={handleLogout}
                  className="w-10 h-10 flex items-center justify-center rounded-full transition-all duration-200 bg-white/10 hover:bg-white/20 hover:scale-105 active:scale-95 text-white/90"
                >
