...
function DistributorQRScannerModal({ isOpen, onClose, onProductAssigned }) {
  ...
  const assignProduct = async () => {
    try {
      setLoading(true);
      await axios.put(
        `${API_URL}/api/distributor/products/assign-by-serial`,
...
export default DistributorQRScannerModal;
