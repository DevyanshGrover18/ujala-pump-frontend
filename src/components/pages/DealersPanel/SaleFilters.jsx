    ...
    const fetchData = async () => {
      try {
        const [modelsRes, dealersRes] = await Promise.all([
          axios.get(`${API_URL}/api/dealer/products/${user.dealer._id}/models`),
          // axios.get(`${API_URL}/api/distributors/${user.distributor._id}/models`),
          // axios.get(`${API_URL}/api/distributors/${user.distributor._id}/products`),
          // axios.get(`${API_URL}/api/sales/dealer-sales`),
          // axios.get(`${API_URL}/api/distributors/${user.distributor._id}/dealers`)
          axios.get(`${API_URL}/api/dealer/my-sub-dealers`),
        ]);

        console.log('modelsRes - ', modelsRes.data[0]);
        // console.log('dealersRes - ',dealersRes.data);
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                >
                  <option value="all">All Sub Dealers</option>
                  {dealers.map((dealer) => (
