    ...
    <div className="fixed inset-0 bg-black/80 bg-opacity-20 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-4 sm:p-6 lg:p-4 w-full max-w-4xl max-h-[95vh] overflow-y-auto">
        ...
        <form onSubmit={onSubmit}>
              ...
              <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-200">
                ...
                <button
                  ...
                  onClick={() =>
                    onDealerChange({
                      ...newDealer,
                      eligibleForIncentive: !newDealer.eligibleForIncentive,
                    })
                  }
              ...
              <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-200">
                ...
                <button
                  ...
                  onClick={() =>
                    onDealerChange({
                      ...newDealer,
                      eligibleForPoints: !newDealer.eligibleForPoints,
                    })
                  }
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
          ...
          {activeTab === 'account' && (
            <AccountDetailsForm
              savedPayoutDetails={newDealer.savedPayoutDetails}
              onChange={(details) =>
                onDealerChange({ ...newDealer, savedPayoutDetails: details })
              }
            />
          )}
