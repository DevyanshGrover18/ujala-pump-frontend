        ...
        <div className="flex items-center justify-between mb-4 flex-shrink-0">
          <div>
            <h3 className="text-lg font-bold text-gray-900">
              Sales History for {distributor?.name}
            </h3>
            <p className="text-xs text-gray-500 mt-1">Dispatches to dealers and direct customer sales.</p>
          </div>
          <div className="flex items-center space-x-4">
            {filteredSales && filteredSales.length > 0 && (
              <TableExportButtons
                exportName={`${distributor?.name || 'Distributor'}_Sales`}
